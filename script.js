...
const revealTargets = [
  ...document.querySelectorAll(
    ".section, .update-widget, .pillar-grid article, .research-grid article, .publication-list article, .document-card, .project-card, .experience-card, .education-card, .teaching-grid > div, .blog-grid article, .timeline article, .article-card"
  )
];
