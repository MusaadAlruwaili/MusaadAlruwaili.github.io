...
document.querySelectorAll("[data-translate-page]").forEach((link) => {
  const canonicalUrl = document.querySelector('link[rel="canonical"]')?.href || window.location.href;
  link.href = `https://translate.google.com/translate?sl=en&tl=ar&u=${encodeURIComponent(canonicalUrl)}`;
});
